...
const Page = () => {
  ...
  const accept = async (idb) => {
    try {
      const { data } = await axios.get(`/api/partner/bookings/${idb}/accept`);
      console.log(data);
    } catch (err: any) {
  ...
  const reject = async (idb: any) => {
    try {
      const { data } = await axios.get(`/api/partner/bookings/${idb}/reject`);
      console.log(data);
    } catch (err: any) {
      console.log(err.response?.data);
      console.log(err.response?.status);
